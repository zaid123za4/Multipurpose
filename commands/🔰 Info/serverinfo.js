...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      embed.addField("**<a:Arrow:1259399777351897108> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:no:1249307494656901133> \`No Channel\`"}`, true)
      embed.addField("**<a:Arrow:1259399777351897108> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:no:1249307494656901133> \`No Channel\`"}`, true)
      embed.addField("**<a:Arrow:1259399777351897108> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:no:1249307494656901133> \`No Channel\`"}`, true)

      embed.addField("**<a:Arrow:1259399777351897108> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<a:Arrow:1259399777351897108> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<a:Arrow:1259399777351897108> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<a:Arrow:1259399777351897108> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:no:1249307494656901133> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<a:Arrow:1259399777351897108> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<a:Arrow:1259399777351897108> SERVER DISCOVERY SPLASH:**`)
